        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(startPose)
                                ...
                                .splineToLinearHeading(new Pose2d(-14, 20, Math.toRadians(0)), Math.toRadians(0))
                                ...
                                .splineToLinearHeading(new Pose2d(-20, 12, Math.toRadians(-90)), Math.toRadians(0))
